...
This document describes how to copy and customise the ciudadaniastheme (bootstrapbase) theme so that
...
From your Moodle theme directory right click on ciudadaniastheme and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of ciudadaniastheme.
...
underscores. For the purpose of this tutorial we will call the theme 'ciudadaniasthemetheme'.

On opening 'ciudadaniasthemetheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_ciudadaniastheme.php
...
where the old theme name occurs, in this case ciudadaniastheme. So using the above list as
a guide, search through and change all the instances of the theme name
'ciudadaniastheme' to 'ciudadaniasthemetheme'. This includes the filename of the lang/en/theme_ciudadaniastheme.php.
You need to change this to 'theme_ciudadaniasthemetheme.php'.
...
and then click on (ciudadaniasthemetheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the ciudadaniastheme theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > ciudadaniastheme
